...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo IMG; ?>v.png" />
    ...
    <body class="login">
            ...
            <div class="logo">
                <center>
                    <table>
                        <tr>
                            <td>
                                <img src="<?php echo IMG; ?>v.png" height="100" alt="Defensoria Pública da União" >
                            </td>
                            <td>
                                <font size="5" color="#FFFFFF">Anoreg<br></font>
                            </td>
                        </tr>
                    </table>
                </center>
        ...
        <div class="clearfix visible-xs-block visible-sm-block">
            <p align="center">
                <img src="<?php echo IMG; ?>v.png" height="100" alt="">
                <br/><br/>
                <font size="4" color="#FFFFFF">Anoreg</font>
            </p>
        </div>
        <!-- FIM LOGO -->
        ...
        <div class="content">
            ...
            <form class="login-form" role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'login.php' ?>">
                ...
                <div class="create-account">
                    <center>
                        <p>Informações do Sistema procure o <b>Resposável</b></p>
                        <p>+55 (61)98409-9965 | samuel.cruz@dpu.def.br<p/>
                    </center>
                </div>
            </form>
