    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            <div class="modal-header" align="center">
                ...
                <h4 class="modal-title"><b>EDITAR PERFIL DO USUÁRIO</b></h4>
            </div>
                            ...
                            <div id="resultModal" class="fetched-data">
                                ...
                                <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group col-md-6">
                                        <label style="text-align:left !important;" >CPF:</label>
                                        <input class="form-control" type="text" name=""  value="" id="cpf" type="text" p disabled> 
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label style="text-align:left !important;" >Telefone:</label>
                                        <input class="form-control" type="text" name=""  value="" id="telefone" type="text"  disabled> 
                                    </div>
                                      <div class="form-group col-md-6">
                                        <label style="text-align:left !important;" >Email:</label>
                                        <input class="form-control" type="text" name=""  value="" id="email" type="text"  disabled> 
                                    </div>
