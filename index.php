...
<?php if (@$_SESSION['VALID'] and ( $modulo != 'login' )) { ?>
    ...
    <html lang="br">
        <head>
            ...
            <!-- BEGIN PACE JS -->
            <script src="<?php echo JS; ?>pace/pace.js" type="text/javascript"></script>
            <link href="<?php echo JS; ?>pace/themes/blue/pace-theme-center-circle.css" rel="stylesheet" type="text/css" />
            <style>
